            ...
            <div className="responsive-grid" style={{ width: '100%', maxWidth: '1200px', marginBottom: '5rem' }}>
                <div className="glass-card">
                    ...
                    <div style={{ marginTop: 'auto', width: '100%' }}>
                        <button className="premium-button" style={{ padding: '1rem 2rem', width: '100%' }}>Get Started</button>
                    </div>
                </div>
                <div className="glass-card">
                    ...
                    <div style={{ marginTop: 'auto', width: '100%' }}>
                        <button className="premium-button" style={{ padding: '1rem 2rem', width: '100%' }}>Learn More</button>
                    </div>
                </div>
            </div>
