/**
 * Client-side mirror of backend booking pricing (keep in sync with backend/utils/bookingPricing.js).
 */

export function getUnitPrice(event, ticketType) {
...
export function calculateBookingTotal(event, quantity, ticketType) {
